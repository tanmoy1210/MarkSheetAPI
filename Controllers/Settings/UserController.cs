...
namespace MT.Controllers.Settings
{
    ...
    [ApiController]
    public class UserController : ControllerBase, IController
    {
        ...
        public UserController(IConfiguration configuration)
        {
            ...
            _IService = new UserCreationService(_configuration);
        }
        ...
        {
            log.Debug($"UserCreation with params: {R_PRM} starts");
            try
            {
                ...
                log.Debug($"UserCreation process with params: {R_PRM} and Return object: {returnObject} ends");
