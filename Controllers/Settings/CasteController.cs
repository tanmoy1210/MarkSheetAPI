...
namespace MT.Controllers.Settings
{
    ...
    [ApiController]
    public class CasteController : ControllerBase, IController
    {
        private static readonly log4net.ILog log = log4net.LogManager.GetLogger(typeof(CasteController));
        protected readonly IService _IService;
        protected readonly IConfiguration _configuration;
        public CasteController(IConfiguration configuration)
        {
            _configuration = configuration;
            _IService = new CasteCategoryService(_configuration);
        }
